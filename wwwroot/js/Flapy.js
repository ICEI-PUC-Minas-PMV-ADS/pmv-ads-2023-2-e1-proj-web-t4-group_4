    ...
    function applyGravity() {
        ...
        document.addEventListener('keydown', (e) => {
            if (e.key == 'ArrowUp' || e.key == ' ') {
                img.src = 'https://github.com/MarlonJames99/Flappy_Bird/blob/main/img/Bird-2.png?raw=true';
                birdDy = -7.6;
            }
        });
        ...
        document.addEventListener('keyup', (e) => {
            if (e.key == 'ArrowUp' || e.key == ' ') {
                img.src = 'https://github.com/MarlonJames99/Flappy_Bird/blob/main/img/Bird.png?raw=true';
            }
        });
