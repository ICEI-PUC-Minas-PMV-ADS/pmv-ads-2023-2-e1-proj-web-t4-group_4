// Importações
import * as conexoes from './sonic.conexao.js';
import * as modulos from './sonic.modulos.js';
...
const start = () => {
    ...
    setTimeout(() => {
        ...
        modulos.imgMario.src = './img/sonic.gif';
        time();
...
const controlePartida = () => {
    const loopControlePartida = setInterval(() => {
        ...
        if (posicaoTuboLeft <= 120 && posicaoTuboLeft >= 50 && posicaoMarioBottom <= 110) {
            ...
            modulos.imgMario.src = './img/Design.png';
            modulos.imgMario.style.width = '200px';
